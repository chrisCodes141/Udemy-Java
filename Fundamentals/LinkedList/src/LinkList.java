class LinkList{
    ...
    public void insertFirstLink(String bookName, int millionsSold){
        ...
        //COnnects the firstLink field tot he new Link
    ...
    public Link removeLink(String bookName){
        ...
        //Keep searching as long as amatch isn't made
        ...
        if(currentLink == firstLink){
            //If you are here that means there was a match in ref stored firstLink in the Linked List so just assign next to firstLink
            firstLink = firstLink.next;
        } else {
            //If you are here there was a match in a link other than the firstLink.
            //Assign the value of next for the Link u want to delete to the Link thats
            //next previously pointed to the ref to remove
